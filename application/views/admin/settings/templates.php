...
, "advance_salary_email" => array("{SITE_NAME}", "{NAME}"), "advance_salary_approve_email" => array("{SITE_NAME}", "{AMOUNT}", "{DEDUCT_MOTNH}"), "advance_salary_reject_email" => array("{SITE_NAME}"), "award_email" => array("{SITE_NAME}", "{NAME}", "{AWARD_NAME}", "{MONTH}"), "new_job_application_email" => array("{SITE_NAME}", "{NAME}", "{JOB_TITLE}", "{EMAIL}", "{MOBILE}", "{COVER_LETTER}"), "call_for_interview" => array("{SITE_NAME}", "{NAME}", "{JOB_TITLE}", "{DESIGNATION}", "{DATE}", "{NOTE}")
